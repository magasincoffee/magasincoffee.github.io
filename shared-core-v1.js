...
global.MAGASIN_CORE={version:'1.1.0',TZ,DAYS,date:{dateKey,localDate,addDays,monday,weekDays,formatDate},time:{time5,minutes,shiftKind},security:{escapeHtml},roles:{label:roleLabel,hasRole},supabase:{create,get:getSupabase,getSession,getProfile,requireActive,rpc},stores:{accessible},ui};
})(globalThis);})();