...
Owner released this track for **DIRECT MANUAL WORK only**; Robot remains disabled. TASK-090→TASK-095 are **DONE**. TASK-095 Employee Published Weekly Schedule V1 is **DONE / E2E-04 STRONG / POST-MERGE GREEN** with evidence at `05_SYSTEM/TASK_095_EMPLOYEE_PUBLISHED_WEEKLY_SCHEDULE_V1.md`. Workforce cursor is now TASK-096 **READY / MANUAL_WORK** → TASK-097; TASK-096 must not auto-run and TASK-097→108 remain staged behind the sequential gate.

TASK-095 implementation PR #245 final head is `d08fa9fef785755b309384a8247fac737fa663c1`, merged as `6e5617bae5cea60473f4aa1546295016ee0f174b`. PR-head People Shift `35677658047` / job `106587440586` and exact post-merge People Shift `35677762865` / job `106587761948` are GREEN on Node v20.20.2 with 187/187 deterministic checks, all 9 browser suites and 0 failures. Production migration `20260922015212_task_095_employee_published_weekly_schedule_v1` remains live and exact-source matched. Employee weekly schedule is own-user/APPROVED/exact-week scoped; canonical schedule publication no longer creates new CLOCK_OUT_REMINDER events.
