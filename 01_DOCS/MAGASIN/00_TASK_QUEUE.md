...
| TASK-033 | Give Shift production primitive | 20m | migration/RLS/RPC + browser E2E | READY |
| TASK-034 | Notification event-outbox production | 20m | migration/RLS/triggers + SQL/integration tests | QUEUED |
