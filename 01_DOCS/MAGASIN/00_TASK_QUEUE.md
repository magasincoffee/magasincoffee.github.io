...
> Architecture is Owner-approved. Owner released Workforce Operations V1 for DIRECT MANUAL WORK execution only. Robot remains disabled for this track. TASK-090→TASK-106 are DONE. TASK-106 Workforce Cross-Flow Browser E2E Pack is DONE with evidence at 05_SYSTEM/TASK_106_WORKFORCE_CROSS_FLOW_BROWSER_E2E_PACK.md. E2E-12 is CLOSED; E2E-13 is CLOSED; E2E-14 remains PARTIAL / TASK-101+104 PROFILE+PAYROLL-AUTH READ SIDE CLOSED with TASK-107 failure/recovery/security pending. TASK-107 is READY / MANUAL_WORK but has not started and MUST NOT auto-run; TASK-108 remains staged until Brain accepts TASK-107. Current PFC queue remains independently authoritative.
...
| TASK-107 | Workforce Failure / Recovery / Security E2E | 20m | retry/reload/idempotency/RBAC | READY / MANUAL_WORK |
