...
Current production contract: LƯU WORK hot-swap is released by TASK-RBT-003, finite global browser scheduling by TASK-RBT-004, inactivity-based long-running recovery by TASK-RBT-005, relay exhaustion recovery by TASK-RBT-005A, multi-signal Work-full rollover by TASK-RBT-006, durable stale/missing exact-target quarantine by TASK-RBT-006A, deterministic explicit Owner START latch recovery by TASK-RBT-006B, process-first Control Panel timeline/resource observability by TASK-RBT-007, and optional machine-correlated Brain ACCEPT/REJECT planning hooks by TASK-RBT-008 (runtime v2026-09-20.60).
...
TASK-RBT-008 adds backward-compatible optional previous_result ACCEPT/REJECT and correction_of metadata while keeping the action/task/instruction core and MAGASIN_LANE_DIRECTIVE_V1 markers unchanged. Transport relay confirmation remains separate from semantic ACCEPT.
