...
const actorCopy=()=>actorRole()==='OWNER'
 ...
 : {title:'Xếp lịch tuần',subtitle:'Availability là dữ liệu đầu vào; chỉ lịch đã phát hành mới là lịch làm chính thức.',source:'Dữ liệu do nhân viên đăng ký; đây là nguồn đầu vào cho xếp lịch canonical.'};
