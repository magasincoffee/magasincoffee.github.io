-- TASK-035
-- Production migration applied via Supabase as version 20260918120917.
-- Provider-independent email target resolution + permanent no-target skip.
-- No email provider, sender account or credential is selected here.
